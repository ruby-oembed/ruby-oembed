...
module OEmbed
  ...
  class Providers
    ...
    FacebookPost = OEmbed::Provider.new('https://www.facebook.com/plugins/post/oembed.json/?url={format}')
    ...
    FacebookVideo = OEmbed::Provider.new('https://www.facebook.com/plugins/video/oembed.json/?url={format}')
