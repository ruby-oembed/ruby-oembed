...
* Data from OEmbed::Providers.urls and OEmbed::Providers.fallback accessors
  are longer mutable. Please always use OEmbed::Providers.register and
  OEmbed::Providers.register_fallback to add providers.
* Removed the following public methods:
  * OEmbed::Provider#name
  * OEmbed::Provider#url
  * OEmbed::Provider#build
  * OEmbed::Provider#raw
  * OEmbed::Providers#raw
  * OEmbed::ProviderDiscovery#raw
* Removed the following built-in OEmbed::Providers
  * OEmbed::Providers::OohEmbed
  * OEmbed::Providers::Skitch
  * OEmbed::Providers::Qik
  * OEmbed::Providers::Yfrog

=== New

* Any method use used to call on OEmbed::Providers can now be called on OEmbed directly (e.g. OEmbed.register_all)
* Begin using rubocop to enforce code consistency.
* Added the following built-in OEmbed::Providers
  * OEmbed::Providers::Noembed (Aggregator)
  * OEmbed::Providers::Kinomap (Minor)

=== Changes

* Divided built-in OEmbed::Providers into categories:
  Default, Minor, & Aggregator
* Lots of internal refactoring & code cleanup to reach base rubocop standards.
