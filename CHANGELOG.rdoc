...
* OEmbed::Response::Photo#html now includes alt attribute (François de Metz)
** TODO: make sure the above change doesn't cause problems if no title is returned in the oEmbed response.
* Added built-in provider for Skitch (François de Metz)
